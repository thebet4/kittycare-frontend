...
export const LoginForm: FC<OTPLoginFormProps> = ({
  ...
  const handleGoogleOAuthSuccess = (email: string) => {
      ...
      {!showOTPInput ? (
        ...
        >
          ...
          <div className="flex items-center">
            <div className="bg-[#898B90] w-full h-[1px] mr-4" />
            <GoogleLoginButton onSuccess={handleGoogleOAuthSuccess} />
            <div className="bg-[#898B90] w-full h-[1px] ml-4" />
          </div>
        </form>
      ) : (
        <OTPForm
